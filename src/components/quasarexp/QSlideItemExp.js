...
import DarkMixin from 'quasar'
import ListenersMixin from 'quasar'

import { slot } from 'quasar/utils/slot.js'
import { cacheWithFn } from 'quasar/utils/cache.js'
  ...
  methods: {
    ...
    __pan(evt) {
      ...
      if (evt.isFirst) {
        ...
        if (this.__scale === 1) {
          node.style.transform = `translate${this.__axis}(${this.__dir * 30}%)`
